...
export default function HeroSection() {
  return (
    <section className="relative w-full overflow-hidden bg-[#1B1A20] group/hero">
      ...
      <div className="relative z-10 max-w-[1140px] mx-auto px-margin-mobile lg:px-margin-desktop py-space-3xl lg:py-[100px] flex flex-col justify-center min-h-[600px]">
        <div className="max-w-2xl flex flex-col gap-space-md opacity-0 animate-[fadeIn_1s_ease-out_forwards]">
          ...
          <h1 className="font-[family-name:var(--font-headline)] text-[36px] lg:text-[44px] text-white font-medium leading-tight drop-shadow-sm">
            Bono Contribución para la Casa Sacerdotal
          </h1>

          <p className="font-[family-name:var(--font-body)] text-[16px] lg:text-[18px] text-inverse-on-surface/90 leading-relaxed max-w-xl">
            La comunidad parroquial se prepara para comenzar con los arreglos edilicios de la Casa sacerdotal. Necesitamos de todos. Te invitamos a sumarte como Padrino de la iniciativa o adquirir el nuevo Bono Contribución.
